...
def Run3():  
    ...
    MoveToAngle(150, 150, -700, -700)
    while leftSensor.reflection() != 11:
        leftMotor.dc(50)
        rightMotor.dc(50)
    MoveToAngle(280, 280, 680, 700)
    leftMedMotor.run(1000)
    time.sleep(2)
    leftMedMotor.hold()
...
def Run5():
    ...
    MoveToAngle(160, 0, -600, 0)
    MoveToAngle(300, 300, -600, -600)
    SinglePDTrackTillDegrees(1000, 3, 50, 0.75, 10, -60)
    ...
    MoveToAngle(150, 150, 1000, 1000)
    rightMedMotor.run(1000)
    MoveToAngle(200, 200, 50, 50)
    rightMedMotor.hold()
...
def ActualRun1():
    ...
    SinglePDTrackTillJunction(1, 12, 2, 50, -0.55, -10, -75)
    # parcel drop
    MoveToAngle(55,55,-600,-600)
    time.sleep(0.1)
    MoveToAngle(120, 120, 200,200)# reverse from parcel
    time.sleep(0.1)
    ...
    MoveToAngle(550,550,1000,1000) #wall align
    time.sleep(0.1)
    MoveToAngle(20, 20, -600,-600)# reverse from parcel
    time.sleep(0.1)
    MoveToAngle(0,125,0,-500) #turn towards line
    MoveToAngle(265,265,-500,-500)
    MoveToAngle(100,0,-500,0)
    SinglePDTrackTillDegrees(150, 2, 50, 0.75, 10, -40) #trace to middle of the path
    rightMedMotor.run(1000) #turn down the attachment
    leftMedMotor.run(-500) #drop the cargo
    time.sleep(0.8)
    rightMedMotor.hold()
    ...
    time.sleep(0.5)
    rightMedMotor.hold()
    MoveToAngle(250,250,1000,1000) # give spacing
    MoveToAngle(100,100,1000,-1000)
    ...
    SinglePDTrackTillDegrees(1000, 1, 50, -0.65, -10, -80)
