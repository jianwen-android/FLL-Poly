...
WaitForPress()
WriteOnScreen("Launching")
MoveToAngle(350, 350, -1000, -1000)
SinglePDTrackTillJunction(2, 12, 3, 50, -0.63, -1, -60)
MoveToAngle(180, 180, -600, -600)
MoveToAngle(230, 0, -600, 0)
rightMedMotor.run(-1000)
time.sleep(0.5)
rightMedMotor.hold()
WaitForPress()
MoveToAngle(220, 220, 600, 600)
# MoveToAngle(300, 300, 600, 600)
# MoveToAngle(400, 200, 600, 600)
# rightMedMotor.run(1000)
# time.sleep(2)
# MoveToAngle(1250, 1250, 700, 680)
# rightMedMotor.run(-1000)
